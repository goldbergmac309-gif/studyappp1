...
// Validate ../../src/app/(dashboard)/subjects/[subjectId]/page.tsx
{
  const handler = {} as typeof import("../../src/app/(dashboard)/subjects/[subjectId]/page.js")
  handler satisfies AppPageConfig<"/subjects/[subjectId]">
}
